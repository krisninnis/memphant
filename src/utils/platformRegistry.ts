...
const BUILT_IN_PLATFORMS: ReadonlyArray<Omit<AIPlatformConfig, 'enabled'>> = [
  ...
  },
  {
    ...
    category: 'dev',
    exportStyle: 'code-heavy',
    promptPrefix: 'Use this project state for repo verification and code inspection.',
    builtIn: true,
    icon: '💻',
    color: '#10a37f',
    description: 'OpenAI Codex CLI — repo verification and code inspection',
  },
  {
    id: 'cowork',
    name: 'Claude Code',
    category: 'dev',
    exportStyle: 'code-heavy',
    promptPrefix: 'Use this project state for continuity review and architecture analysis.',
    builtIn: true,
    icon: '🔧',
    color: '#d97706',
    description: 'Claude Code / Cowork — continuity review and architecture analysis',
  },
  {
    id: 'ollama',
    name: 'Ollama',
